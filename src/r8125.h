...
#ifdef DISABLE_USE_FIRMWARE_FILE
#undef ENABLE_USE_FIRMWARE_FILE
#endif

// Default is to enable NAPI
#define CONFIG_R8125_NAPI
#ifdef DISABLE_R8125_NAPI
#undef CONFIG_R8125_NAPI
#endif

// Default is to enable VLAN
#define CONFIG_R8125_VLAN
#ifdef DISABLE_R8125_VLAN
#undef CONFIG_R8125_VLAN
#endif
...
/* Software IRQ coalescing timer gro_flush_timeout
  Raised from 20000, can be changed with "echo 20000 > /sys/class/net/<device>/gro_flush_timeout" */
#if NUM_TX_DESC == 2048
#define SW_IRQ_COALESCING_TIMEOUT 60000    /* 45000 to 50000 for 4096 descriptors, 35000 for 1024 */
#elif NUM_TX_DESC == 4096
#define SW_IRQ_COALESCING_TIMEOUT 70000    /* 45000 to 50000 for 4096 descriptors, 35000 for 1024 */
#else
#define SW_IRQ_COALESCING_TIMEOUT 65000    /* 45000 to 50000 for 4096 descriptors, 35000 for 1024 */
#endif
...
void rtl8125_hw_disable_mac_mcu_bps(struct rtl8125_private *tp);
inline void rtl8125_mark_to_asic(struct rtl8125_private *tp, struct RxDesc *desc);
void rtl8125_mark_as_last_descriptor(struct rtl8125_private *tp, struct RxDesc *desc);
void rtl8125_clear_set_mac_ocp_bit(struct rtl8125_private *tp, u16 addr, u16 clearmask, u16 setmask);
